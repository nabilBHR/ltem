...
<body class="animsition">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url(images/master-slide-02.png);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						...
						<span class="caption2-slide1 m-text1 t-center animated visible-false m-b-33" data-appear="rotateInUpRight">
							Votre application qui vous permet de suivre et de contrôler votre consommation énergétique
						</span>

						<div class="wrap-btn-slide1 w-size1 visible-false">
							<!-- Button -->
							<a href="connexion.php" class="flex-c-m size2 bo-rad-23 s-text2 bgwhite hov1 trans-0-4">
								CONNEXION
							</a>
							<br>
							<a href="inscription.php" class="flex-c-m size2 bo-rad-23 s-text2 bgwhite hov1 trans-0-4">
								INSCRIPTION
							</a>
	...
	<!--===============================================================================================-->
	<script type="text/javascript" src="libs/vendor/countdowntime/countdowntime.js"></script>
	<!--===============================================================================================-->
	<script type="text/javascript" src="libs/vendor/lightbox2/js/lightbox.min.js"></script>
	<!--===============================================================================================-->
	<script type="text/javascript" src="libs/vendor/sweetalert/sweetalert.min.js"></script>
	<!--===============================================================================================-->
	<script type="text/javascript" src="libs/vendor/parallax100/parallax100.js"></script>
