...
def generate_component_json(data):
  ...
  d = {
    ...
    "license": "MIT",
    "styles": [
      "libs/css/%s.css" % (data['name'].lower())
    ],
    "fonts": [
      "libs/fonts/%s.eot" % (data['name'].lower()),
      "libs/fonts/%s.svg" % (data['name'].lower()),
      "libs/fonts/%s.ttf" % (data['name'].lower()),
      "libs/fonts/%s.woff" % (data['name'].lower())
    ]
  }
