									...
									<table class="table-shopping-cart table-hover ">
										...
										?>
											<tr class="table-row">
												...
												<td class="column-6">
													<a href="dashboard.php"> <button type="button" class="btn btn-outline-info" id="but<?php echo $tab[0];?>"><i class="fa fa-thermometer-empty" aria-hidden="true"></i> Capturer </button></a>
													<a href="deleteKit.php?imei=<?php echo $tab[0]; ?>"><button type="button" class="btn btn-outline-danger" id="but<?php echo $tab[0];?>"><i style="float: left;" class="fa fa-trash-o"></i> Supprimer </button></a>
												</td>
											</tr>
										<?php } ?>
									</table>
